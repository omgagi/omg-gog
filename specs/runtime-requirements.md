...
| REQ-RT-004 | Should | req_rt_004_flow_mode_remote_exists, req_rt_004_step1_generates_url_with_state, req_rt_004_step2_validates_state_extracts_code, req_rt_004_step2_state_mismatch_returns_error, req_rt_004_step2_missing_state_file_returns_error, req_rt_004_step2_no_state_in_url, req_rt_004_remote_mode_returns_step_instruction, req_rt_004_step1_force_consent, req_rt_004_step1_unique_state_each_call | rt-arch Module 4: auth/oauth_flow.rs (remote) | remote_flow_step1, remote_flow_step2, run_remote_flow @ `src/auth/oauth_flow.rs` |
...
| REQ-RT-014 | Should | req_rt_014_encrypt_decrypt_roundtrip, req_rt_014_encrypted_store_set_get_delete, req_rt_014_wrong_password_fails_decrypt, req_rt_014_unencrypted_mode_no_password, req_rt_014_encrypted_store_list_tokens, req_rt_014_encrypted_implements_credential_store, req_rt_014_derive_key_deterministic, req_rt_014_derive_key_different_passwords, req_rt_014_encrypt_random_nonce, req_rt_014_decrypt_truncated_data, req_rt_014_encrypted_data_not_plain_json | rt-arch Module 5: auth/keyring.rs (encrypted file backend) | EncryptedFileCredentialStore, encrypt, decrypt, derive_key @ `src/auth/keyring.rs` |
...
| REQ-RT-029 | Should | req_rt_029_resumable_upload_url, req_rt_029_resumable_threshold_is_5mb, req_rt_029_resumable_chunk_size | rt-arch Module 11: cli/mod.rs (drive resumable upload) | build_resumable_upload_url, RESUMABLE_THRESHOLD, RESUMABLE_CHUNK_SIZE @ `src/services/drive/files.rs`, handle_drive_resumable_upload @ `src/cli/mod.rs` |
