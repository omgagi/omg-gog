...
| REQ-RT-002 | Must | (filled by test-writer) | rt-arch Module 4: auth/oauth_flow.rs (desktop) | `src/auth/oauth_flow.rs` |
| REQ-RT-003 | Must | (filled by test-writer) | rt-arch Module 4: auth/oauth_flow.rs (manual) | `src/auth/oauth_flow.rs` |
| REQ-RT-004 | Should | (filled by test-writer) | rt-arch Module 4: auth/oauth_flow.rs (remote) | `src/auth/oauth_flow.rs` |
...
| REQ-RT-008 | Must | (filled by test-writer) | rt-arch Module 11: cli/mod.rs (handle_auth_add) | `src/cli/mod.rs` |
| REQ-RT-009 | Must | (filled by test-writer) | rt-arch Module 11: cli/mod.rs (handle_auth_remove) | `src/cli/mod.rs` |
| REQ-RT-010 | Must | (filled by test-writer) | rt-arch Module 11: cli/mod.rs (handle_auth_list) | `src/cli/mod.rs` |
| REQ-RT-011 | Must | (filled by test-writer) | rt-arch Module 11: cli/mod.rs (handle_auth_status) | `src/cli/mod.rs` |
| REQ-RT-012 | Must | (filled by test-writer) | rt-arch Module 11: cli/mod.rs (handle_auth_tokens) | `src/cli/mod.rs` |
